...
/* Define to 1 if you have the declaration of `UCT_PROGRESS_THREAD_SAFE
   UCT_CB_FLAG_SYNC', and to 0 if you don't. */
/* #undef HAVE_DECL_UCT_PROGRESS_THREAD_SAFE_UCT_CB_FLAG_SYNC */
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/home/ubuntu/MPI_Programs/openmpi-4.0.0/opal/mca/event/libevent2022/libevent -I/home/ubuntu/MPI_Programs/openmpi-4.0.0/opal/mca/event/libevent2022/libevent/include -I/home/ubuntu/MPI_Programs/openmpi-4.0.0/opal/mca/hwloc/hwloc201/hwloc/include  ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static   --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "4.0.0"
...
#define OPAL_IDENT_STRING "4.0.0"
...
#define OPAL_PACKAGE_STRING "Open MPI root@master Distribution"
...
#define OPAL_RELEASE_DATE "Nov 12, 2018"
...
#define OPAL_TARBALL_VERSION "4.0.0"
...
#define ORTE_RELEASE_DATE "Nov 12, 2018"
...
#define OSHMEM_TARBALL_VERSION "4.0.0"
...
#define PACKAGE_STRING "Open MPI 4.0.0"
